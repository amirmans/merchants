                        ...
                        <div class="col-md-12  padding-0">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-title">
                                    Add Product Option
                                        <a href="<?php echo base_url('index.php/product/options/'.$product_id); ?>" class="btn btn-danger  back-button add_product_btn pull-right"><i class="fa fa-arrow-left"></i>Back</a>
                                </div>
